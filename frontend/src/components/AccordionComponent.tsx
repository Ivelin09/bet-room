		...
		<>
			<div className="sm:w-[1170px] md:w-[80%] w-[90%] my-[50px] mx-auto py-[60px] ">
				...
				<Accordion variant="bordered">
					<AccordionItem key={`1`} aria-label="Accordion 1" title="Guaranteed Long-Term Profitability">
					...
					<AccordionItem key={`2`} aria-label="Accordion 1" title="Expertly Curated Combos">
					...
					<AccordionItem key={`3`} aria-label="Accordion 1" title="Variety of Options">
					...
					<AccordionItem key={`4`} aria-label="Accordion 1" title="Transparent Performance Tracking">
					...
					<AccordionItem key={`5`} aria-label="Accordion 1" title="Dedicated Customer Support">
